...
<reference>
@/Users/T.Finizzi/repo/FineTuning-Envelope/.claude/get-shit-done/references/user-profiling.md
...
Read the user-profiling reference document at `/Users/T.Finizzi/repo/FineTuning-Envelope/.claude/get-shit-done/references/user-profiling.md` to load:
