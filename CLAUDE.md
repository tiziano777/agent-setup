...
This project is indexed by GitNexus as **agent-setup** (3100 symbols, 6552 relationships, 250 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
